      ...
      <div className={`${ !isMobile ? styles.headerWrap : !isHome ? styles.headerHidden : styles.headerMobile } ${ (isHome && !isMobile) || (location.pathname === '/about') ? styles.header2Wrap : null}`}>
        <Link to={"/"} className={styles.linkStyle}>
          <div className={styles.logo} onClick={homeClick}>
            <object data={isHome && !isMobile ? logo : isMdDesktop || isWdDesktop ? logoLong : logoInitials} className={isHome && !isMobile ? styles.logoObject : isHome && isMobile ? styles.mobileLongLogoObject : styles.logoLongObject} type="image/svg+xml" >
