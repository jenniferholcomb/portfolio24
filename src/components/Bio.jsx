  ...
  return (
    <>
      <div className={styles.bioContainer}>
        <p className={styles.bioStyle}>I&apos;m a problem solver, a builder, a thinker, and a maker. All strengths that have carried me through many creative endeavors &mdash; graphic and logo design, building brand identities, accessory design, pattern engineering, and front end web development along with UX/UI design. My design ethos - I look for problems in our communities, and innovate creative solutions. I focus on a user, listen to their needs, and design around their preferences. I help others by developing a product that improves or enhances their day. 
        <br /><br />
        If not at home in Portland, you&apos;ll find me at the coast. All that the ocean offers; clamming, crabbing, sunsets, beach fires, seafood, sand, and general soul recharging. 
        </p>
      </div>
